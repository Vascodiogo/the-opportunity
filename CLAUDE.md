...
2. **Tech Stack:** EIP-2612 permits enable gasless, one-signature subscription authorization for USDC and EURC only. USDT and DAI have no permit support — always two-step approve+subscribe. Do not describe permits as universal across all supported tokens.
