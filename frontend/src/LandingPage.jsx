      ...
      <section style={{
        ...
        <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 18, color: text, lineHeight: 1.8, margin: 0, fontWeight: 300 }}>
            {lang === "en"
              ? "AuthOnce is a non-custodial subscription protocol built on Base Network. Subscribers authorise a one-time payment intent — their tokens stay in their own wallet and are pulled automatically on schedule. Merchants receive funds directly. No intermediary. Everything is on-chain, auditable, and unstoppable."
              : "O AuthOnce é um protocolo de subscrição não custodial construído na Base Network. Os subscritores autorizam uma intenção de pagamento única — os seus tokens ficam na sua própria carteira e são cobrados automaticamente. Os comerciantes recebem os fundos diretamente. Sem intermediários. Tudo é on-chain, auditável e imparável."}
          </p>
        </div>
      </section>
